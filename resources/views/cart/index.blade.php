...
{{--                    <tr>--}}
{{--                        <td>{{ $item['title'] }}</td>--}}
{{--                        <td>{{ $item['brand'] ?? 'Невідомий бренд' }}</td>--}}
{{--                        <td>{{ $item['price'] }} &#8372;</td>--}}
{{--                        <td>--}}
...
{{--            <a href="{{ route('cart.clear') }}" class="btn btn-warning">Очистити кошик</a>--}}
{{--            <a href="{{ route('orders.create') }}" class="btn btn-primary">Оформити замовлення</a>--}}
{{--        @else--}}
